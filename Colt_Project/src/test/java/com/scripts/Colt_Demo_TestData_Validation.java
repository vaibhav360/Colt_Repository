...
public class Colt_Demo_TestData_Validation extends DriverTestCase {

	@Test(dataProviderClass = DataProviderRepository.class, dataProvider = "getData")
	public void test_01_check_Connectivity_and_price_of_sites(String QuoteName, String Description, String segment,
			String Resiliency, String BandWidth, String buildingType, String SiteAAddress, String SiteBAddress,
			String NRC_net, String MRC_net) throws Exception {
		...
		reportLog("Login into application with: " + username + "and Password: " + password);
		...
		colt_DemoHelper.selectDropdownByValue("smeSegment", segment);
